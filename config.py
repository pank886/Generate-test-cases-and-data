...
# ====== Phase A 双集合配置 ======
COLLECTION_PRODUCT_DOCS = os.environ.get("COLLECTION_PRODUCT_DOCS", "product_docs")
COLLECTION_API_DEFS = os.environ.get("COLLECTION_API_DEFS", "api_defs")
CHUNK_SIZE = 1000
CHUNK_OVERLAP = 200
...
PYCHARM_MISC = os.environ.get("PYCHARM_MISC", r"D:\pycharm&&python\Generate-test-cases-and-data")
